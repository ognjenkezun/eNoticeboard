...
It may be that at the first launch not all services are started (Icon not green): Left-click Wampmanager icon then Restart the services.
...
-- VC15 Redistribuable (Visual C++ 2017) Replaced by VC16
