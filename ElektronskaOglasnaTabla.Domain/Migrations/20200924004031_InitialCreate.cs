        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnnouncementExpiry = table.Column<int>(nullable: false),
                    SlideDurationOnTv = table.Column<int>(nullable: false),
                    AutomaticallyUpdate = table.Column<int>(nullable: false),
                    NumberOfLastAnnPerCategory = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnnouncementDescription = table.Column<string>(nullable: true),
                    AnnouncementDateCreated = table.Column<DateTime>(nullable: false),
                    AnnouncementDateModified = table.Column<DateTime>(nullable: true),
                    AnnouncementExpiryDate = table.Column<DateTime>(nullable: false),
                    AnnouncementImportantIndicator = table.Column<int>(nullable: false),
                    ...
                    CategoryId = table.Column<int>(nullable: false),
                    AnnouncementShow = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Announcements_AspNetUsers_UserModifiedId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Announcements_UserCreatedId",
                table: "Announcements",
                column: "UserCreatedId");

            migrationBuilder.CreateIndex(
                name: "IX_Announcements_UserModifiedId",
                table: "Announcements",
